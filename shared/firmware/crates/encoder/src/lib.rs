...
impl Encoder {
    ...
    pub fn position_rad(&self) -> f32 {
        (self.count as f32 / self.counts_per_rev as f32) * 2.0 * core::f32::consts::PI
    }

    pub fn velocity_rad_per_sec(&self) -> f32 {
        (self.velocity_counts_per_sec / self.counts_per_rev as f32) * 2.0 * core::f32::consts::PI
    }
...
mod tests {
    ...
    fn test_full_revolution() {
        ...
        assert!(
            (pos - 2.0 * core::f32::consts::PI).abs() < 1e-5,
            "Expected 2π, got {}",
            pos
        );
    }
    ...
    fn test_velocity() {
        ...
        assert!(
            (vel - 2.0 * core::f32::consts::PI).abs() < 1e-5,
